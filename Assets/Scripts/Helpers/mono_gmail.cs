...
public class Mono_gmail
{
    ...
    public void Main(String[] filePaths, int weekNo)
    {
        ...
        mail.From = new MailAddress("ryan.noone87@gmail.com"); 
        mail.To.Add("connor.reid87@gmail.com,acats@griffith.edu.au");
        mail.Subject = "PST Logs";
        ...
        for (int i = 0; i < filePaths.Length; i++){
            if (filePaths[i] != null && !filePaths[i].Equals(""))
            {
                ...
                {
                    Debug.Log("mono_gmail: Main: File does not exist: " + filePaths[i]);
                }
            }
            else
            {
                Debug.Log("mono_gmail: Main: File null or empty: " + filePaths[i]);
            }
        }
        SmtpClient smtpServer = new SmtpClient("smtp.gmail.com");
        smtpServer.Port = 587;
        smtpServer.Credentials = new System.Net.NetworkCredential("ryan.noone87@gmail.com", "Ghadmuska69") as ICredentialsByHost;
